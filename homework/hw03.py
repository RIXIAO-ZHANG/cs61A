...
def replace_leaf(t, old, new):
    ...
    """
    "*** YOUR CODE HERE ***"
    if is_leaf(t) and label(t) == old:    #Every leaf value
        return tree(new)
    else:
        new_list = [replace_leaf(branch,old,new) for branch in branches(t)]
...
def balanced(m):
    ...
    if is_weight(m):
        ...
        return balanced(left_side) and balanced(right_side) and torque_left == torque_right

    ...
    def highest_score(score0,score1):
        if who:
            ...
            if score0 == previous_score:
                ...
                current_gain = score0 - previous_score
                if current_gain > previous_high:
                    print(current_gain, "point(s)! That's the biggest gain yet for Player", who)
                    return announce_highest(who,current_gain,score0sub)
                else:
                    return announce_highest(who,previous_high,score0)

...
class Bee(Insect):
    ...
    def action(self, colony):
        ...
        # BEGIN EC
        "*** YOUR CODE HERE ***"
        if self.has_scared and not self.forward:
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive,min_range=0,max_range=float('inf')):
        ...
        while temp_place is not hive:
            if range_count >= self.min_range and range_count <= self.max_range and temp_place.bees:
...
class NinjaAnt(Ant):
    ...
    def action(self, colony):
        ...
        "*** YOUR CODE HERE ***"
        """
        It damages all Bees that pass by, but can never be stung.
        """
...
# END Problem 13
    ...
    def __init__(self, armor=1):
        ...
        self.identity = QueenAnt.identity
        QueenAnt.identity = False
        # END Problem 13
    ...
    def action(self, colony):
        ...
        if self.identity:
            ...
            while temp_place:
                if temp_place.ant:
                    if not temp_place.ant.action_performed:
                        temp_place.ant.damage *= 2
                        temp_place.ant.action_performed = True
                    if temp_place.ant.is_container and temp_place.ant.contained_ant and not temp_place.ant.contained_ant.action_performed:
                        temp_place.ant.contained_ant.damage *= 2
                        temp_place.ant.contained_ant.action_performed = True
